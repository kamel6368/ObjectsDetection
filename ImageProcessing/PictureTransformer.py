import cv2
import numpy as np
from DataModel.enums import ColorSpace
...
class PictureTransformer:
    ...
    def merge_pictures(self, pictures, color_space, ignore_dark_images=False):
        """
        ...
        for picture in pictures:
            if ignore_dark_images and \
                            self.percentage_of_bright_pixels(picture, color_space) < \
                            self.pictures_merge_dark_pixels_percentage_border:
