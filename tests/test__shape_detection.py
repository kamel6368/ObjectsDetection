...
from DataModel.enums import Shape
from ImageProcessing.shape_detection import _align_points
from ImageProcessing.shape_detection import detect_shape


class ShapeDetectionTest(TestCase):

    def test__align_points(self):
    ...
    def test__triangle_detection(self):
    ...
    def test__quadrilateral_detection(self):
    ...
    def test__n_polygons_detection(self):
    ...
    def test__conics_detection(self):
        assert detect_shape(np.array(
